...
module.exports = function (RED) {
    function setWorkplaceState(config) {
        ...
        node.on('input', async function (msg) {
            ...
            let requestBody = bodyCreator.workplaceBody(msg.topic, msg.payload, msg.timestamp); //topic = workplace, payload = status 
            ...
            const optionsCookie = {
                ...
                url: endpoint.href,
                headers: {
                    'Cookie': mipclient.getCookie(accessId), //changed [] to ()
            ...
            //console.log(mipclient.getCookie(accessId));
